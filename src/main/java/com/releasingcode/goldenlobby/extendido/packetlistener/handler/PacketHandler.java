...
import com.releasingcode.goldenlobby.extendido.reflection.resolver.FieldResolver;
import com.releasingcode.goldenlobby.extendido.reflection.resolver.MethodResolver;
import com.releasingcode.goldenlobby.extendido.reflection.resolver.minecraft.NMSClassResolver;
import com.releasingcode.goldenlobby.extendido.reflection.util.AccessUtil;
...
public abstract class PacketHandler {
    ...
    public boolean equals(Object object) {
        ...
        if (hasSendOptions != that.hasSendOptions) {
            return false;
        }
        if (forcePlayerSend != that.forcePlayerSend) {
            return false;
        }
        if (forceServerSend != that.forceServerSend) {
            return false;
        }
        if (hasReceiveOptions != that.hasReceiveOptions) {
            return false;
        }
        if (forcePlayerReceive != that.forcePlayerReceive) {
            return false;
        }
        if (forceServerReceive != that.forceServerReceive) {
            return false;
        }
