package com.releasingcode.goldenlobby.extendido.nms.v1_11_R1;

import com.releasingcode.goldenlobby.connections.ServerManager;
import com.releasingcode.goldenlobby.extendido.nms.v1_11_R1.packets.*;
...
import us.minecub.lobbymc.extendido.nms.v1_11_R1.packets.*;
...
public class NPC_v1_11_R1 extends NPCBase {
    ...
    public NPC_v1_11_R1(NPCLib instance, String name, List<String> lines, UUID uuid, String nameNPC) {
    ...
    public void sendMetadataPacket(Player player) {
        PlayerConnection playerConnection = ((CraftPlayer) player).getHandle().playerConnection;
        PacketPlayOutEntityMetadata packet = new PacketPlayOutEntityMetadataWrapper().create(activeStates,
                entityId);
